...
if os.path.exists("E:/Bahan Kuliah (Semester 4) Git/neural-networks-and-deep-learning/data/mnist_expanded.pkl.gz"):
    print("The expanded training set already exists.  Exiting.")
else:
    f = gzip.open("E:/Bahan Kuliah (Semester 4) Git/neural-networks-and-deep-learning/data/mnist.pkl.gz", 'rb')
